...
class Blueprint
  ...
  RAILS_PATH =            File.join(Blueprint::ROOT_PATH, "../../")
  BLUEPRINT_ROOT_PATH =   File.join(Blueprint::RAILS_PATH, "public/stylesheets/blueprint")
  ...
  SETTINGS_FILE =         File.join(Blueprint::RAILS_PATH, "config/blueprint.yml")
