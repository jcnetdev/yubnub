...
set :repository, "https://railsmade.unfuddle.com/svn/railsmade_sendcircle/[APP NAME]"
set :server, "photos.sendcircle.com"

# ------------
# SET YOUR ENVIRONMENT VARIABLES 
# RAILSMADE_SVN_USERNAME & RAILSMADE_SVN_PASSWORD
# ------------
set :scm_username, ENV["RAILSMADE_SVN_USERNAME"]
set :scm_password, ENV["RAILSMADE_SVN_PASSWORD"]
